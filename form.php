   ...
   <form action="" method="POST">
          ...
          Пол:<br/>
              <input type="radio" checked="checked"
                     name="radio-group-1" value="Значение1" <?php if ($values['radio-group-1']=='Женский'){print 'checked';} ?>>
              Женский
              <input type="radio"
                     name="radio-group-1" value="Значение2" <?php if ($values['radio-group-1']=='Мужской'){print 'checked';} ?>>
              Мужской<br/>
          Количество конечностей:<br/>
              <input type="radio" checked="checked"
                     name="radio-group-2" value="Значение1" <?php if ($values['radio-group-2']=='2(или меньше)'){print 'checked';} ?>>
              2(или меньше)
              <input type="radio"
                     name="radio-group-2" value="Значение2" <?php if ($values['radio-group-2']=='3-15'){print 'checked';} ?>>
              3-15
              <input type="radio"
                     name="radio-group-2" value="Значение3" <?php if ($values['radio-group-2']=='16(или больше)'){print 'checked';} ?>>
              16(или больше)<br/>
              Сверхспособности:
              <br/>
